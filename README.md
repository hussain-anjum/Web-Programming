...
This repository contains my lab work and solutions for the **CSE-308: Internet and Web Programming Lab** course.  
Each exercise focuses on practical web development using **PHP, JavaScript, HTML, and CSS**, including form handling, data validation, database operations, and interactive design.
...
|  8  | Employee Profile Validation    | Insert employee info and validate input data.                                        | `EmployeeProfileValidation/` |
